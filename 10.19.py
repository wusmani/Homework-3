...
class ShoppingCart:
    def __init__(self, customer_name='none', current_date='February 1, 2016', cart_items=[]):
...
def print_menu(newCart):
        ...
        while command != 'q':
            ...
            while command != 'a' and command != '0' and command != 'i' and command != 'q' and command != 'r' and command != 'c':
                command = input('Choose an option:\n')
            if command == 'a':
                print('\nADD ITEM TO CART')
